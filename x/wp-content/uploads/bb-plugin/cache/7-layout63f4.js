...
{$('body').off('uabb-trigger.'+hook,callback);},};})(jQuery);jQuery(document).ready(function($){var uabb_browser=bowser.name,uabb_browser_v=bowser.version,uabb_browser_class=uabb_browser.replace(/\s+/g,'-').toLowerCase(),uabb_browser_v_class=uabb_browser_class+parseInt(uabb_browser_v);$('html').addClass(uabb_browser_class).addClass(uabb_browser_v_class);});var wpAjaxUrl='https://rab.berkeley.edu/wp-admin/admin-ajax.php';var flBuilderUrl='https://rab.berkeley.edu/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://rab.berkeley.edu/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'https://rab.berkeley.edu/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);jQuery(function($){$(function(){$('.fl-node-5839f9bf25b2b .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});(function($){BBTimelineAnimation=function(settings)
...
else{module.removeClass('bb-hide-it');module.addClass(animation_class);}},};})(jQuery);(function($){$(document).ready(function(){new BBTimelineAnimation({id:'5d5ed510c9fd0',timeline:0,mobile_screen:'off',animation_delay:'0.2',animation:'animated fadeInDown',viewport_position:'90'});new BBTimelineAnimation({id:'5d5ed510c9fd0',timeline:1,mobile_screen:'off',animation_delay:'0.2',animation:'animated fadeInDown',viewport_position:'90'});new BBTimelineAnimation({id:'5d5ed510c9fd0',timeline:2,mobile_screen:'off',animation_delay:'0.2',animation:'animated fadeInDown',viewport_position:'90'});new BBTimelineAnimation({id:'5d5ed510c9fd0',timeline:3,mobile_screen:'off',animation_delay:'0.2',animation:'animated fadeInDown',viewport_position:'90'});new BBTimelineAnimation({id:'5d5ed510c9fd0',timeline:4,mobile_screen:'off',animation_delay:'0.2',animation:'animated fadeInDown',viewport_position:'90'});new BBTimelineAnimation({id:'5d5ed510c9fd0',timeline:5,mobile_screen:'off',animation_delay:'0.2',animation:'animated fadeInDown',viewport_position:'90'});});})(jQuery);jQuery(document).ready(function($){$('.fl-content-carousel').bxSlider({pager:true,auto:true,autoControls:true,speed:1000,slideSelector:'div.fl-carousel-item',minSlides:1,maxSlides:1,moveSlides:4,slideWidth:700,shrinkItems:true,});});jQuery(function($){$(function(){$('.fl-node-587875b7b7426 .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});var TxtType=function(el,toRotate,period){this.toRotate=toRotate;this.el=el;this.loopNum=0;this.period=parseInt(period,10)||2000;this.txt='';this.tick();this.isDeleting=false;};TxtType.prototype.tick=function(){var i=this.loopNum%this.toRotate.length;var fullTxt=this.toRotate[i];if(this.isDeleting){this.txt=fullTxt.substring(0,this.txt.length-1);}else{this.txt=fullTxt.substring(0,this.txt.length+1);}
